...
//        alasKakis = DataProvider.getAlasKakisByTipe(this,jenisHewan);
//        inisialisasiView();
//        tampilkanProfil();
//    }
//
...
//        txJudul.setText("Berbagai Macam Jenis" +jenisHewan);
//    }
//
//
//    private void tampilkanProfil() {
//        AlasKaki k = alasKakis.get(indeksTampil);
...
//        if (indeksTampil == alasKakis.size() - 1) {
//            Toast.makeText(this,"Sudah di posisi terakhir",Toast.LENGTH_SHORT).show();
//            return;
//        } else {
//            indeksTampil++;
